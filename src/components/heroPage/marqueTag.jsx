...
<Link href="/heropage/category">
  <button
    className="
      flex items-center justify-center border-[1.5px] border-[#04DA8D] rounded-full  gap-1 font-medium text-center  text-[14px] sm:text-[16px] lg:text-[18px] w-[120px] sm:w-[135px] lg:w-[150px] h-[36px] sm:h-[40px] lg:h-[43px] cursor-pointer " >
    See More
