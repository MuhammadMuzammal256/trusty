                ...
                >
                  <div className="mb-4 flex items-start gap-3">
                    ...
                    <div className="min-w-0 pt-[2px]">
                      <h3 className="truncate text-[14px] font-semibold text-[#000000]">
                        {item.name}
                      </h3>
                      <p className="mt-[3px] truncate text-[12px] text-[#8A8F98]">
                        {item.website}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between gap-3">
                    <div className="flex min-w-0 items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <p className="truncate text-[16px] font-semibold text-[#2A2A2A]">
                          {item.user}
                        </p>
                        <div className=" flex items-center gap-1">
                          <span className="truncate text-[15px] font-light text-[#1A1A1A]">
                            Top Contributor
                          </span>
                    ...
                    <span className="shrink-0 text-[13px] font-light text-[#A1A1AA]">
                      15 mins ago
                    </span>
                  </div>
                </div>
