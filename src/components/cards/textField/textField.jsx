      ...
      <div className="flex items-center bg-white border border-[#E1E3F6] rounded-full overflow-hidden h-[55px] sm:h-[60px] md:h-[65px] lg:h-[75px]">
        ...
        <div className="flex flex-1">
          <input
            ...
            className=" w-full outline-none text-[#2A2A2A] px-2 sm:px-3 md:px-4 text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px]"
          />
        </div>

        <div className="h-full">
          <button className=" bg-[#04DA8D] h-full flex items-center justify-center px-3 sm:px-4 md:px-5 lg:px-6">
      ...
      >
        {categories.map((item, index) => (
          <div
            ...
            className="cursor-pointer text-[#17253F] px-3 sm:px-4 py-2 sm:py-3 text-[13px] sm:text-[14px] md:text-[15px]  hover:bg-[#F5F7FF]  ">
            {item}
          </div>
        ))}
      </div>
